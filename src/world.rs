...
fn create_resources(assets: &Assets) -> [Vec<Rc<RefCell<Resource>>>; 5] {
    ...
    let l3_data = [
        (500., Vec2::new(-929.39, 273.9), -1, -1, -1, assets.l3_bridge.clone()),
        (100., Vec2::new(0.73, -27.29), -1, -1, -1, assets.l3_l2_object.clone()),
        (100., Vec2::new(-148.21, 58.76), -1, -1, -1, assets.l3_l2_object.clone()),
        (500., Vec2::new(-1541.75, 429.49), -1, -1, -1, assets.l3_airport.clone()),
        (200., Vec2::new(197.68, 611.54), -1, -1, -1, assets.l3_hotairbaloon.clone()),
        (150., Vec2::new(-982.35, -22.32), -1, -1, -1, assets.l3_boat.clone()),
        (150., Vec2::new(-719.20, -341.74), -1, -1, -1, assets.l3_boat.clone()),
        (90., Vec2::new(-1316.6667, -47.15), -1, -1, -1, assets.l3_tree.clone()),
        (90., Vec2::new(-1415.96, -275.54), -1, -1, -1, assets.l3_tree.clone()),
        (90., Vec2::new(-1190.88, -244.1), -1, -1, -1, assets.l3_tree.clone()),
        (300., Vec2::new(-598.38, -45.49), -1, -1, -1, assets.l3_crane.clone()),
        (100., Vec2::new(-461.01, -164.65), -1, -1, -1, assets.l3_container.clone()),
        (100., Vec2::new(-341.85, -139.83), -1, -1, -1, assets.l3_container.clone()),
        (100., Vec2::new(-413.02, -263.96), -1, -1, -1, assets.l3_container.clone()),
        (100., Vec2::new(-1442.44, -91.83), -1, -1, -1, assets.l3_cow.clone()),
        (100., Vec2::new(-1334.87, -196.10), -1, -1, -1, assets.l3_cow.clone()),
        (150., Vec2::new(-240.90, 263.99), -1, -1, -1, assets.l3_building.clone()),
        (100., Vec2::new(-535.49, 297.09), -1, -1, -1, assets.l3_building.clone()),
        (100., Vec2::new(-479.22, -396.36), -1, -1, -1, assets.l3_whale.clone()),
        (100., Vec2::new(-343.51, -432.77), -1, -1, -1, assets.l3_whale.clone()),
    ];
